...
export const HighlightedProjectsMotion: React.FC<Props> = ({
  ...
  return (
    <section className="relative min-h-screen py-20 lg:py-32 overflow-hidden bg-gradient-to-br from-stone-50 via-gray-50 to-stone-100">
      {/* Dynamic Background Elements - Updated to match InteriorContent */}
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Subtle geometric pattern - Updated to match InteriorContent */}
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <motion.div
          ...
          <motion.div
            ...
            {/* Floating icon badge with enhanced design - Updated to match InteriorContent */}
            <motion.div
            ...
            {/* Main title with specified sizing - Updated to match InteriorContent */}
            ...
            {/* Enhanced description with specified sizing - Updated to match InteriorContent */}
            <motion.p
              variants={itemVariants}
            ...
            {/* Animated divider - Updated to match InteriorContent */}
            <motion.div
              variants={itemVariants}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {projects.map((project) => (
                <motion.div
                  ...
                  {/* Enhanced glow effect - Updated to match InteriorContent */}
                  <div className="absolute -inset-2 bg-gradient-to-r from-amber-400/20 to-yellow-500/20 rounded-3xl opacity-0 group-hover:opacity-100 transition-all duration-500 blur-xl -z-10" />
                  <div className="absolute -inset-1 bg-gradient-to-r from-amber-500/10 to-yellow-600/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 -z-10" />
                </motion.div>
              ))}
            </div>
          </motion.div>

          {/* Enhanced CTA Section - Updated to match InteriorContent */}
          <motion.div
            variants={itemVariants}
            className="text-center mb-16 lg:mb-24">
            <Link href="/danh-muc/du-an">
              <motion.button
                whileHover={{
                  scale: 1.05,
                  boxShadow: "0 25px 50px rgba(217, 119, 6, 0.3)", // Amber-ish shadow
                }}
                whileTap={{ scale: 0.95 }}
                className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-amber-600 via-yellow-600 to-amber-700 hover:from-amber-700 hover:via-yellow-700 hover:to-amber-800 text-white px-8 py-4 lg:px-12 lg:py-6 rounded-2xl text-base lg:text-xl font-bold transition-all duration-500 shadow-2xl hover:shadow-amber-500/25 overflow-hidden">
          ...
          {/* Enhanced Stats Section - Updated to match InteriorContent's color scheme */}
          {projects.length > 0 && (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 lg:gap-8">
                {[
                  ...
                  <motion.div
                    ...
                    <motion.div
                      className="text-2xl sm:text-3xl lg:text-4xl font-black text-stone-800 mb-2"
          ...
          {/* Enhanced Portfolio Showcase Hint - Updated to match InteriorContent */}
          <motion.div variants={itemVariants} className="flex justify-center">
            <div className="relative group">
              {/* Glow effect */}
              <div className="absolute -inset-1 bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 rounded-full blur opacity-25 group-hover:opacity-40 transition duration-500" />
