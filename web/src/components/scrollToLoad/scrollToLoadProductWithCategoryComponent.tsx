...
export const ScrollToLoadProductsWithCategory: React.FC<
  ScrollToLoadProductsProps
> = ({
  fetchProducts,
  itemsPerPage = 8,
  loadingComponent,
  ...
  return (
    <div className={`w-full ${containerClassName} mt-[60px] `}>
      {/* Header */}
      <div className="text-center mb-2 md:mb-16">
        ...
        <p className="hidden md:block text-base sm:text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
          Khám phá những sản phẩm được khách hàng yêu thích và đánh giá cao — từ
          thiết kế hiện đại đến giải pháp nội thất thông minh.
        </p>
      ...
      <ProductWrapperCard hiddenGridButton={false} products={products} />
